...
// .wrangler/tmp/bundle-zPZxKP/checked-fetch.js
...
// .wrangler/tmp/bundle-zPZxKP/strip-cf-connecting-ip-header.js
...
var products = [
  {
    ...
    description: "iPhone 15 Pro Max v\u1EDBi chip A17 Pro, camera 48MP, khung titan, m\xE0n h\xECnh Super Retina XDR 6.7 inch."
  },
  {
    id: 2,
    ...
    description: "Samsung Galaxy S24 Ultra trang b\u1ECB chip Snapdragon 8 Gen 3, camera 200MP, S-Pen t\xEDch h\u1EE3p."
  },
  {
    id: 3,
    name: "MacBook Air M3",
    ...
    description: "MacBook Air M3 si\xEAu m\u1ECFng, chip Apple M3, 8GB RAM, m\xE0n h\xECnh Liquid Retina 13.6 inch."
  },
  {
    id: 4,
    name: "iPad Pro M4",
    ...
    description: "iPad Pro M4 v\u1EDBi m\xE0n h\xECnh OLED tandem, chip M4 m\u1EA1nh m\u1EBD, h\u1ED7 tr\u1EE3 Apple Pencil Pro."
  },
  {
    id: 5,
    name: "AirPods Pro 2",
    ...
    description: "AirPods Pro 2 v\u1EDBi chip H2, ch\u1ED1ng \u1ED3n ch\u1EE7 \u0111\u1ED9ng, USB-C, \xE2m thanh kh\xF4ng gian c\xE1 nh\xE2n h\xF3a."
  },
  {
    id: 6,
    ...
    description: "Apple Watch Ultra 2 v\u1EDBi chip S9, m\xE0n h\xECnh 2000 nits, GPS ch\xEDnh x\xE1c 2 t\u1EA7n s\u1ED1, l\u1EB7n 40m."
  }
];
...
function layout(title, body, cart) {
...
<body>
<header>
  <a href="/" class="logo">\u{1F6D2} QShop</a>
  <nav>
    <a href="/">S\u1EA3n ph\u1EA9m</a>
    <a href="/cart">Gi\u1ECF h\xE0ng${count > 0 ? `<span class="badge">${count}</span>` : ""}</a>
  </nav>
</header>
<main>${body}</main>
<footer>\xA9 2026 QShop \u2014 Made with \u2764\uFE0F by Qu\u1ED1c Jee</footer>
</body>
</html>`;
}
...
app.get("/", (c) => {
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form method="POST" action="/cart/add">
          ...
          <button class="btn" type="submit">\u{1F6D2} Th\xEAm v\xE0o gi\u1ECF</button>
        </form>
      </div>
    </div>`
  ).join("");
  return c.html(
    layout(
      "Trang ch\u1EE7",
      `<h2 style="margin-bottom:20px">\u{1F4F1} S\u1EA3n ph\u1EA9m n\u1ED5i b\u1EADt</h2><div class="grid">${cards}</div>`,
      cart
    )
  );
});
app.get("/product/:id", (c) => {
  ...
  if (!p)
    return c.html(
      layout(
        "Kh\xF4ng t\xECm th\u1EA5y",
        '<div class="empty"><span>\u{1F622}</span>S\u1EA3n ph\u1EA9m kh\xF4ng t\u1ED3n t\u1EA1i.<br><a href="/" class="btn" style="margin-top:16px">\u2190 V\u1EC1 trang ch\u1EE7</a></div>',
        cart
      ),
      404
    );
...
app.get("/cart", (c) => {
  ...
  if (cart.length === 0) {
    return c.html(
      layout(
        "Gi\u1ECF h\xE0ng",
        '<div class="empty"><span>\u{1F6D2}</span>Gi\u1ECF h\xE0ng tr\u1ED1ng!<br><a href="/" class="btn" style="margin-top:16px">\u2190 Mua s\u1EAFm ngay</a></div>',
        cart
      )
    );
  }
  ...
  const html = `
  <h2 style="margin-bottom:20px">\u{1F6D2} Gi\u1ECF h\xE0ng c\u1EE7a b\u1EA1n</h2>
  <table>
    <thead><tr><th>S\u1EA3n ph\u1EA9m</th><th>\u0110\u01A1n gi\xE1</th><th>SL</th><th>Th\xE0nh ti\u1EC1n</th></tr></thead>
    <tbody>${rows}</tbody>
  </table>
  <div class="total">T\u1ED5ng c\u1ED9ng: ${formatVND(total)}</div>
  <div style="margin-top:20px;display:flex;gap:12px;justify-content:flex-end">
    <a href="/" class="btn btn-outline">\u2190 Ti\u1EBFp t\u1EE5c mua</a>
    <button class="btn" onclick="alert('C\u1EA3m \u01A1n b\u1EA1n \u0111\xE3 \u0111\u1EB7t h\xE0ng! \u{1F389}')">\u0110\u1EB7t h\xE0ng</button>
  </div>`;
  return c.html(layout("Gi\u1ECF h\xE0ng", html, cart));
});
...
// .wrangler/tmp/bundle-zPZxKP/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-zPZxKP/middleware-loader.entry.ts
